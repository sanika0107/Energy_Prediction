...
## 📊 Results
- The **Linear Regression** model achieved approximately **97% accuracy**.  
...
| File | Description |
|------|--------------|
| `Plant_1_Solar_Prediction_Model_Final_Week` | Main Colab notebook with graphs, model training, and accuracy |
| `README.md` | Documentation for Final Week tasks |
